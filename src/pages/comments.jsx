...
export const Comments = () => {
  const comments = [
    { id: "fashgsa", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec non dolor porta, " +
      ...
      author: "matic jeseničnik", created: "2021-12-12 12:14:55.555", cond: true },
    { id: "ghaioga", message: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam suscipit sapien tellus, " +
      ...
      author: "alen budimir", created: "2021-12-12 12:14:55.555", cond: false },
    { id: "gihasga", message: "react app testing third message", author: "anonymous", created: "2021-12-12 12:14:55.555", cond: true }
  ];
  ...
  return (
    <div className={"space-y-5 grid justify-items-center py-6"}>
      ...
      {comments.map(({ id, message, author, created, cond}) => (
